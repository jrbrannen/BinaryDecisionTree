...
public class Question {
	...
	/**
	 * This method creates new Question objects and checks the yes and no properties
	 * and compares it to the user input to respond with the appropriate question or
	 * answer. Method will run until it gets to a leaf or (null, null).
	 */
